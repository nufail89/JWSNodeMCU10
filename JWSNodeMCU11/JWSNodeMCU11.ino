...
void tampilDMD(){
  ...
  // =========================================
  switch(RunSel){
    case 1: anim_DT();  break;
    case 2: dwMrq(addSpace(configinfo.nama),configinfo.kecepatan,1); break;
    case 3: dwMrq(drawDayDate() ,configinfo.kecepatan,2); break;
    case 4: drawSholat(); break;
    case 5: dwMrq(addSpace(configinfo.info1),configinfo.kecepatan,2); break;
    case 6: anim_DT();  break;
    case 7: dwMrq(addSpace(configinfo.info2),configinfo.kecepatan,1); break;
    case 8: drawSholat(); break;
  ...
  switch(RunFinish){
    ...
    case 8: RunSel = 1; RunFinish =0; break;
    case 100: {
      if(jumat){
